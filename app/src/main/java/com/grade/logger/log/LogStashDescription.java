...
public class LogStashDescription implements BaseDestination {
  ...
  public LogStashDescription(LogLevel logLevel) {
    ...
    entriesFile = new File(LogContext.getInstance().getFilesDir().getAbsolutePath(), "logger.json");
    sendingFile = new File(LogContext.getInstance().getFilesDir().getAbsolutePath(),
        "logger.sending.json");
  ...
  public void setFileName(String fileName) {
    entriesFile = new File(LogContext.getInstance().getFilesDir().getAbsolutePath(),
        fileName + ".json");
    sendingFile = new File(LogContext.getInstance().getFilesDir().getAbsolutePath(),
